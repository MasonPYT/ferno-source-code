	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			...
			case 'thorns':
				...
				FlxG.sound.music.fadeIn(1, 0, 0.8);
			case 'ignite':
				FlxG.sound.playMusic(Paths.music('Ignite'), 0);
				FlxG.sound.music.fadeIn(1, 0, 0.8);
			case 'ember':
				FlxG.sound.playMusic(Paths.music('Ember'), 0);
				FlxG.sound.music.fadeIn(1, 0, 0.8);
		}
		...
		else if (PlayState.SONG.song.toLowerCase() == 'ignite')
		{
		...
		else if (PlayState.SONG.song.toLowerCase() == 'ember')
		{
			portraitLeft = new FlxSprite(-1500, 10);
			portraitLeft.frames = Paths.getSparrowAtlas('portraits/fireguyPortrait', 'shared');
			portraitLeft.animation.addByPrefix('enter', 'Senpai Portrait Enter instance 1', 24, false);
		...
		if (FlxG.keys.justPressed.ANY  && dialogueStarted == true)
		{
			...
			if (dialogueList[1] == null && dialogueList[0] != null)
			{
				if (!isEnding)
				{
					...
					if (PlayState.SONG.song.toLowerCase() == 'senpai' || PlayState.SONG.song.toLowerCase() == 'thorns' || PlayState.SONG.song.toLowerCase() == 'senpai')
