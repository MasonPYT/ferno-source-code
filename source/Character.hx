...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'fireguy':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/FireGuy', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'FireGuy idle', 24);
				animation.addByPrefix('singUP', 'FireGuy up', 24);
				animation.addByPrefix('singRIGHT', 'FireGuy right', 24);
				animation.addByPrefix('singDOWN', 'FireGuy down', 24);
				animation.addByPrefix('singLEFT', 'FireGuy left', 24);
			...
			case 'angyfireguy':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/KoolAidFireGuy', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'FireGuy idle', 24);
				animation.addByPrefix('singUP', 'FireGuy up', 24);
				animation.addByPrefix('singRIGHT', 'FireGuy right', 24);
